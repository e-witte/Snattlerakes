...
rat_dat <- read_csv(here("data/rat_edit.csv")) #load and check data from Allf
view(rat_dat)
...
# from the blog: pruned.tree<-drop.tip(tree, setdiff(tree$tip.label, species));
pruned_tree <- drop.tip(sqtree, (sqtree$tip.label, spec))
...
rat_edit <- read.csv("data/rat_edit.csv")
view(rat_edit)
>>>>>>> b727fe4247a15c229c661d29f222cd81c82ba1ba
